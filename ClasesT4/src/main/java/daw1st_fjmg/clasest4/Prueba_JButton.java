...
public class Prueba_JButton extends JFrame{

  JLabel display;
  JButton boton1, boton2, boton3, botonLimpiar;

  public Prueba_JButton(){
    ...
    private void initHovers(){
      ...
      boton2.addMouseListener(new MouseListener() {
        ...
        public void mouseEntered(MouseEvent e) {
          ...
          boton2.setBorder(new LineBorder(Color.BLUE));
    ...
    botonLimpiar.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent e) {
        ...
        botonLimpiar.setBorder(new LineBorder(Color.RED));
