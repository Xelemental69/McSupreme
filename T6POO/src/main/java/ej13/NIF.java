...
public class NIF {
    ...
    private LocalDate fecCad;//Fecha de caducidad
    
    public NIF(String numDNI, LocalDate fecCad) {//Constructor que toma de parámetro un string de
        //ocho caracteres numéricos:
        
        if(numDNI.length() == 8){//Comprueba si el parámetro es de ocho cifras
            //En caso afirmativo, se continua
            this.fecCad = fecCad;//La fecha de caducidad será la del parámetro.
    ...
    public NIF() {//Constructor por defecto (SAQUEN SUS RULETAS, SEÑORES)
        ...
        fecCad = LocalDate.now();
        fecCad.plusYears(10);
        
    }
    
    public NIF(LocalDate fecCad) {//Constructor que pide la fecha de caducidad (SAQUEN SUS RULETAS, SEÑORES)
    ...
    public LocalDate getFecCad() {
        
        return fecCad;
        
    }
    
    public void renovarCaducidad(LocalDate fecCad){
        
        this.fecCad = fecCad;
        this.fecCad.plusYears(10);
    ...
    public String toString() {//Este método devuelve en String el nº y la letra 
        //del DNI
        return "Su DNI es " + numDNI + "-" + letraDNI + "\nCaduca en " + fecCad;
    }    
